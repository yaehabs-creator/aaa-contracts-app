  ...
  >
    ...
    <div
      style={{
        ...
        width: '50%',
        height: '50%',
        background: 'radial-gradient(circle, rgba(30, 58, 138, 0.15) 0%, rgba(30, 58, 138, 0.05) 40%, transparent 70%)',
        borderRadius: '50%',
        filter: 'blur(40px)',
        pointerEvents: 'none',
      }}
    ...
    <div
      style={{
        ...
        width: '55%',
        height: '55%',
        background: 'radial-gradient(circle, rgba(30, 58, 138, 0.12) 0%, rgba(23, 37, 84, 0.06) 40%, transparent 70%)',
        borderRadius: '50%',
        filter: 'blur(50px)',
        pointerEvents: 'none',
      }}
    ...
    <div style={{ position: 'relative', marginBottom: '1.25rem' }}>
      ...
      <input
        ...
        style={{
          ...
          border: `1.5px solid ${isFocused ? 'rgba(30, 58, 138, 0.5)' : 'rgba(0, 0, 0, 0.08)'}`,
          borderRadius: '14px',
          outline: 'none',
          transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)',
