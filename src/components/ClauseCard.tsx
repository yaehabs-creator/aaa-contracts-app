...
import { normalizeClauseId, findClauseElement, scrollToClauseByNumber } from '@/utils/navigation';
import { TokenizedTextRenderer } from '@/components/admin/TokenizedTextRenderer';
        ...
        <div className="flex flex-wrap items-center justify-between px-8 py-5 border-b border-surface-border bg-surface-bg/50">
          ...
          {onAskAI && (
            <button
              ...
              className="p-2.5 bg-aaa-blue/[0.05] border border-aaa-blue/20 text-aaa-blue hover:bg-aaa-blue hover:text-white rounded-mac-xs transition-all shadow-sm group/ai"
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-1.5 h-1.5 bg-emerald-400 rounded-full border-2 border-white opacity-0 group-hover/ai:opacity-100 transition-opacity"></div>
              </div>
            </button>
          )}
          {onCompare && (
