          ...
          <div className="px-8 py-4 border-b border-surface-border bg-surface-bg/30">
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-2 rounded-mac-xs text-sm font-medium transition-all ${mode === 'single'
              ...
              <button
                ...
                className={`px-4 py-2 rounded-mac-xs text-sm font-medium transition-all ${mode === 'bulk'
                    ? 'bg-mac-blue text-white'
                    : 'bg-white text-mac-muted hover:text-mac-blue border border-surface-border'
                  }`}
              >
