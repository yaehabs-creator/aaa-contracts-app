...
export const Dashboard: React.FC<DashboardProps> = ({ clauses }) => {
  ...
  return (
    <div className="space-y-6 mb-8 animate-in fade-in duration-1000">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-3xl shadow-premium border border-aaa-border card-enter" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-premium border border-aaa-border card-enter" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="bg-aaa-blue p-6 rounded-3xl shadow-2xl text-white relative overflow-hidden group card-enter" style={{ animationDelay: '0.3s' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-aaa-border shadow-premium flex flex-col card-enter" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="flex-1 space-y-4">
            <div className="p-4 bg-aaa-bg border border-aaa-blue/5 rounded-2xl">
        ...
        <div className="bg-white p-6 rounded-3xl border border-aaa-border shadow-premium card-enter" style={{ animationDelay: '0.5s' }}>
