  ...
  return (
    <div className="space-y-6 mb-8 animate-in fade-in duration-1000">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-3xl shadow-premium border border-aaa-border">
        ...
        <div className="bg-aaa-blue p-6 rounded-3xl shadow-2xl text-white relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-aaa-border shadow-premium flex flex-col">
