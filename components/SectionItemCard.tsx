          ...
          <div className="flex items-center gap-3" onClick={(e) => e.stopPropagation()}>
            ...
            {onAskAI && (
              <button
                ...
                className="p-2.5 bg-aaa-blue/[0.05] border border-aaa-blue/20 text-aaa-blue hover:bg-aaa-blue hover:text-white rounded-xl transition-all shadow-sm group/ai"
                title="Ask AI about this specific item"
              >
                <div className="relative">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
                  <div className="absolute -top-1 -right-1 w-2 h-2 bg-emerald-400 rounded-full border-2 border-white opacity-0 group-hover/ai:opacity-100 transition-opacity"></div>
                </div>
              </button>
            )}
          </div>
